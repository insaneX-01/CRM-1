const styles = {
  ...
  Confirmed: "bg-sky-100 text-sky-700 dark:bg-sky-500/10 dark:text-sky-300",
...
export const OrderStatusBadge = ({ status }) => (
  <span className={`inline-flex rounded-full px-2.5 py-1 text-xs font-semibold ${styles[status] || "bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-200"}`}>
    {status}
  </span>
);
